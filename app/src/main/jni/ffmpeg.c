...
#define LOG_TAG "BAKONFFmpeg"
#define  LOGE(...)  __android_log_print(ANDROID_LOG_ERROR,LOG_TAG,__VA_ARGS__)


// function 명은 com_prompt_veaver_NDK.h 파일을 참고하셔서 만드시면 됩니다.

JNIEXPORT jint JNICALL Java_com_abercompany_bakonproto_ndk_NDK_run_1ffmpeg(JNIEnv *env, jobject obj, jstring inputUrl, jstring outputUrl)

{
    // 아래의 명령어를 수행하는 코드입니다.
    // ffmpeg -i /sdcard/input.mp4 -filter:v crop=300:400:10:20 /sdcard/output.mp4
    // ffmpeg -i "rtsp://192.168.1.254/sjcam.mov" -vcodec copy -vb 150000 -f flv rtmp://52.79.147.99:1935/aber/myStream
    // ffmpeg -sdp_file test3.sdp -i "rtsp://192.168.1.254/sjcam.mov" -vcodec copy -vb 150000 -f rtp rtp://127.0.0.1:10000 -vcodec copy -vb 150000 -f flv rtmp://52.79.147.99:1935/aber/myStream


    char* a0 = "ffmpeg";
    char* a1 = "-i";
    char* a2 = (*env)->GetStringUTFChars(env, inputUrl,NULL);
    char* a3 = "-rtsp_flags";
    char* a4 = "listen";
    char* a5 = "-an";
    char* a6 = "-vcodec";
    ...
    char* a16 = "-rw_timeout";
    char* a17 = "10000";
    char* a18 = "-listen_timeout";
    char* a19 = "10000";
    char* a20 = "-f";
    char* a21 = "mp4";
    char* a22 = (*env)->GetStringUTFChars(env, outputUrl,NULL);
    char* argv[23];
        ...
        //argv[23] = a23;
        //argv[24] = a24;
        LOGE("JNI- C Method Call      run_ffmpeg 호출 전   %s  "   ,a22  );

       // (*env)->ReleaseStringUTFChars(env, rtspUrl,a12);

        run_ffmpeg(23, &argv);
        LOGE("JNI- C Method Call      run_ffmpeg 호출 후     "        );
